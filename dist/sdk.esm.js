...
var FACTORY_ADDRESS = '0xE2DC1B3C723A804EA36Fc9b8c4Aa285bD8598f96';
var INIT_CODE_HASH = '0xb62402d0afa626981ebd1f2d8caaf2732acfca3689e50233362513126dd05b24';
...
var Token = /*#__PURE__*/function (_Currency) {
  ...
  function Token(chainId, address, decimals, symbol, name, denormWeight) {
    var _this;

    _this = _Currency.call(this, decimals, symbol, name) || this;
    _this.chainId = chainId;
    _this.address = validateAndParseAddress(address);
    _this.denormWeight = denormWeight;
    return _this;
  }
  /**
...
var WMATIC = (_WMATIC = {}, _WMATIC[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0x4200000000000000000000000000000000000006', 18, 'WMATIC', 'Wrapped Matic'), _WMATIC[ChainId.TESTNET] = /*#__PURE__*/new Token(ChainId.TESTNET, '0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889', 18, 'WMATIC', 'Wrapped Matic'), _WMATIC);
...
var Fraction = /*#__PURE__*/function () {
  ...
  _proto.toSignificant = function toSignificant(significantDigits, format, rounding) {
    ...
    var quotient = JSBI.equal(this.denominator, ZERO) ? new Decimal(0) : new Decimal(this.numerator.toString()).div(this.denominator.toString()).toSignificantDigits(significantDigits);
  ...
  _proto.toFixed = function toFixed(decimalPlaces, format, rounding) {
    ...
    return JSBI.equal(this.denominator, ZERO) ? new Big(0) : new Big(this.numerator.toString()).div(this.denominator.toString()).toFormat(decimalPlaces, format);
  };
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, lpToken) {
    var tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
    ? [tokenAmountA, tokenAmountB] : [tokenAmountB, tokenAmountA];
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, (lpToken === null || lpToken === void 0 ? void 0 : lpToken.address) || Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'PLP', 'PolydexV2 LP');
  ...
  _proto.spotPriceOf = function spotPriceOf(token) {
    !this.involvesToken(token) ? process.env.NODE_ENV !== "production" ? invariant(false, 'TOKEN') : invariant(false) : void 0;
  ...
  _createClass(Pair, [{
    ...
    key: "token0SpotPrice",
    get: function get() {
      var amount0 = JSBI.multiply(this.tokenAmounts[0].raw, JSBI.BigInt(this.token1.denormWeight || 50));
      var amount1 = JSBI.multiply(this.tokenAmounts[1].raw, JSBI.BigInt(this.token0.denormWeight || 50));
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === MATIC && pairs[0].involvesToken(WMATIC[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === MATIC && pairs[pairs.length - 1].involvesToken(WMATIC[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
    var path = [input instanceof Token ? input : WMATIC[pairs[0].chainId]];
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType, overrides) {
    var _overrides$inputAmoun, _overrides$inputAmoun2, _overrides$inputAmoun3, _overrides$outputAmou, _overrides$outputAmou2, _overrides$outputAmou3, _overrides$priceImpac;
    ...
    this.route = route;
    this.tradeType = tradeType; // this.inputAmount = overrides?.inputAmount ?? (
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === MATIC ? CurrencyAmount.ether((_overrides$inputAmoun = overrides === null || overrides === void 0 ? void 0 : (_overrides$inputAmoun2 = overrides.inputAmount) === null || _overrides$inputAmoun2 === void 0 ? void 0 : _overrides$inputAmoun2.raw) !== null && _overrides$inputAmoun !== void 0 ? _overrides$inputAmoun : amounts[0].raw) : (_overrides$inputAmoun3 = overrides === null || overrides === void 0 ? void 0 : overrides.inputAmount) !== null && _overrides$inputAmoun3 !== void 0 ? _overrides$inputAmoun3 : amounts[0]; // this.outputAmount = overrides?.outputAmount ?? (
    ...
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === MATIC ? CurrencyAmount.ether((_overrides$outputAmou = overrides === null || overrides === void 0 ? void 0 : (_overrides$outputAmou2 = overrides.outputAmount) === null || _overrides$outputAmou2 === void 0 ? void 0 : _overrides$outputAmou2.raw) !== null && _overrides$outputAmou !== void 0 ? _overrides$outputAmou : amounts[amounts.length - 1].raw) : (_overrides$outputAmou3 = overrides === null || overrides === void 0 ? void 0 : overrides.outputAmount) !== null && _overrides$outputAmou3 !== void 0 ? _overrides$outputAmou3 : amounts[amounts.length - 1];
    this.executionPrice = new Price(this.inputAmount.currency, this.outputAmount.currency, this.inputAmount.raw, this.outputAmount.raw); // this.nextMidPrice = nextPairs.length ? Price.fromRoute(new Route(nextPairs, route.input)) : {} as Price

    this.nextMidPrice = {};
    this.priceImpact = (_overrides$priceImpac = overrides === null || overrides === void 0 ? void 0 : overrides.priceImpact) !== null && _overrides$priceImpac !== void 0 ? _overrides$priceImpac : computePriceImpact(route.midPrice, this.inputAmount, this.outputAmount);
    this.tokenIn = (overrides === null || overrides === void 0 ? void 0 : overrides.tokenIn) || {};
    this.tokenOut = (overrides === null || overrides === void 0 ? void 0 : overrides.tokenOut) || {};
    this.swapSequences = (overrides === null || overrides === void 0 ? void 0 : overrides.swapSequences) || [];
  }
  /**
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var _trade$tokenIn, _trade$tokenOut, _swapSequences$;

    var etherIn = trade.inputAmount.currency === MATIC;
    var etherOut = trade.outputAmount.currency === MATIC; // the router does not support both ether in and out

    !!(etherIn && etherOut) ? process.env.NODE_ENV !== "production" ? invariant(false, 'MATIC_IN_OUT') : invariant(false) : void 0;
    ...
    var swapSequences = trade.swapSequences;
    var tokenIn = etherIn ? '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE' : (_trade$tokenIn = trade.tokenIn) === null || _trade$tokenIn === void 0 ? void 0 : _trade$tokenIn.address;
    var tokenOut = etherOut ? '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE' : (_trade$tokenOut = trade.tokenOut) === null || _trade$tokenOut === void 0 ? void 0 : _trade$tokenOut.address;
    var multihop = swapSequences.length !== 1;
    var path = Array.isArray(swapSequences) ? (_swapSequences$ = swapSequences[0]) === null || _swapSequences$ === void 0 ? void 0 : _swapSequences$.map(function (s) {
      return s.pool;
    }) : [];
    var methodName;
    var args;
...
var contractName = "IPolyDexPair";
var sourceName = "contracts/interfaces/IPolyDexPair.sol";
var abi = [
	{
		anonymous: false,
		inputs: [
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, IPolydexPair.abi, provider).getReserves()).then(function (_ref) {
...
export { ChainId, Currency, CurrencyAmount, FACTORY_ADDRESS, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MATIC, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WMATIC, currencyEquals, inputOutputComparator, tradeComparator };
