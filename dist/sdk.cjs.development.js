...
var WMATIC = (_WMATIC = {}, _WMATIC[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0x4200000000000000000000000000000000000006', 18, 'WMATIC', 'Wrapped Matic'), _WMATIC[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, '0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889', 18, 'WMATIC', 'Wrapped Matic'), _WMATIC);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === MATIC && pairs[0].involvesToken(WMATIC[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === MATIC && pairs[pairs.length - 1].involvesToken(WMATIC[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    !!(etherIn && etherOut) ?  invariant(false, 'MATIC_IN_OUT')  : void 0;
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IPolydexPair.abi, provider).getReserves()).then(function (_ref) {
